...
{ 
    int  counts=0, arr[]=new int[60],Avail_seats=60,board,destination,inter=0 ,price=23;
    String location[]={"\n1.Erode","\n2.Perundurai","\n3.Avinashi"};
    String Msg1="\t\t\t\t Please wait We are processing your request!!!";
    String Msg2="\n\t\t\tThanks for choosing Ramani!\n";
...
public   void booking2()
   {
     try{
         ...
         System.out.println("\n \t\t\t\t BOOKING CONFIRMED");
         System.out.println("\n Passenger name  :"+name);
         System.out.println("\n Boarding point:"+location[board-1]);
         System.out.println("\n  Destination point:"+location[destination-1]);
         price();
         Seats();
         System.out.println("\n \t\t\t\t Bus Details");
         System.out.println("\n BUS BOOKED :Ramani");
...
public void update()
{
 ...
 try{
   File f =new File("C:\\Users\\user\\OneDrive\\Desktop\\booking\\Ramani.txt")  ;
